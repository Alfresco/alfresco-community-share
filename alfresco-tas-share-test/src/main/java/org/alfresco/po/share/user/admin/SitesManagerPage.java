...
public class SitesManagerPage extends SharePage<SitesManagerPage> implements AccessibleByMenuBar
{
     ...
     *
     * @param siteName String, the site for which actions list is load
     ...
     * @param action String, the action searched in the Actions list
     ...
     *
     * @param siteName site to be updated
     * @param visibility option to be chosen
     */
     ...
     *
     * @param siteName String, the site for which user is or not a manager
     * @return true if the value from I'm a Site Manager column is Yes, false otherwise
     */
