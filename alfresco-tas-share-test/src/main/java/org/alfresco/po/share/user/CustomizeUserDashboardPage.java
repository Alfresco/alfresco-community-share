 ...
 */
@PageObject
public class CustomizeUserDashboardPage extends SharePage<CustomizeUserDashboardPage> implements DashboardCustomization
{
    @Autowired
    ...
    {
        dashboardCustomization.reorderDashletsInColumn(dashletToMove, dashletToReplace, column);
    }
}
