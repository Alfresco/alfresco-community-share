package org.alfresco.share.searching.searchHighlight;
...
public class SearchHighlightTests extends ContextAwareWebTest
{
    ...
    public void createPrecondition()
    {
        ...
        content.createDocument(userName, DataUtil.PASSWORD, siteName, CMISUtil.DocumentType.TEXT_PLAIN, C42558file, C42558file);
        content.createDocument(userName, DataUtil.PASSWORD, siteName, CMISUtil.DocumentType.TEXT_PLAIN, C42560file, docContent);
        content.createDocument(userName, DataUtil.PASSWORD, siteName, CMISUtil.DocumentType.TEXT_PLAIN, C42560file2, docContent);
        content.createDocument(userName, DataUtil.PASSWORD, siteName, CMISUtil.DocumentType.TEXT_PLAIN, C42562file1, docContent);
        content.createDocument(userName, DataUtil.PASSWORD, siteName, CMISUtil.DocumentType.TEXT_PLAIN, C42562file2, docContent);
        content.createDocument(userName, DataUtil.PASSWORD, siteName, CMISUtil.DocumentType.TEXT_PLAIN, C42564file1, docContent);
        content.createDocument(userName, DataUtil.PASSWORD, siteName, CMISUtil.DocumentType.TEXT_PLAIN, C42564file2, docContent);
        content.createDocument(userName, DataUtil.PASSWORD, siteName, CMISUtil.DocumentType.TEXT_PLAIN, C42549file, C42549file);
        content.uploadFileInSite(userName, password, siteName, C42550testFilePath);
