 ...
 */
public class TimeZoneDayViewTests extends BaseTest
{
    //@Autowired
    ...
    @TestRail (id = "C5973")
    @Test(groups = { TestGroup.SANITY, TestGroup.SITES_FEATURES }, enabled = true)
    public void singleDayEvent()
    {
        ...
        calendarPage.clickEvent(currentEventName);
