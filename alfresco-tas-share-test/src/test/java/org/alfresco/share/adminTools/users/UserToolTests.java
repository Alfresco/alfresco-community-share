...
public class UserToolTests extends ContextAwareWebTest
{
    ...
    public void accessingUsersTool()
    {
        ...
        logger.info("Step1: Click 'Admin Tools' link on the header bar.");
    ...
    public void searchingForUser()
    {
        ...
        logger.info("Preconditions: Two users are created; a user with administrator rights is logged into Share.");
        ...
        logger.info("Step3: Type a string contained only by one of the created users into the search box and click 'Search' button.");
