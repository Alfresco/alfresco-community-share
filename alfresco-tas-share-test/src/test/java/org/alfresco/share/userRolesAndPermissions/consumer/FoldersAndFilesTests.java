 ...
 */
public class FoldersAndFilesTests extends ContextAwareWebTest
{
    @Autowired
    ...
    public void setupTest()
    {
        ...
        userService.create(adminUser, adminPassword, user8865, password, user8865 + "@tests.com", user8865, user8865);
