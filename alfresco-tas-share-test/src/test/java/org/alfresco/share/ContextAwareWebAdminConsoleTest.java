...
//    protected void setupAuthenticatedSessionAlfresco(String userName, String password)
//    {
//        getBrowser().navigate().to(properties.getAlfrescoUrl());
//    }
    ...
    protected void navigate(String pageUrl)
    {
        try
        {
            getBrowser().navigate().to(properties.getAlfrescoUrl().toURI().resolve(pageUrl).toURL());
