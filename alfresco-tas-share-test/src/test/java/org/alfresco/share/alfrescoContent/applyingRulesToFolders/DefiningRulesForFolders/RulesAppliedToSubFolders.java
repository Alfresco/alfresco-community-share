...
@Slf4j
public class RulesAppliedToSubFolders extends AbstractFolderRuleTest
{
    ...
    private final String parentFolder = "Parent"+random;
    private final String childFolder = "Child"+random;
    private final String fileName = "TestFile"+random;
    ...
    public void itemsAreUpdatedRuleAppliesToSubfolders()
    {
        ...
        documentLibraryPage
            ...
            .selectItemAction(parentFolder, MANAGE_RULES);
        ...
        getCmisApi().usingSite(site.get()).usingResource(folderToCheck).createFolder(folderToCheck).assertThat().existsInRepo();
        ...
        documentLibraryPage
            .assertFileIsNotDisplayed(fileName);
        ...
        documentLibraryPage
            ...
            .assertFileIsDisplayed(fileName)
            .selectItemAction(fileName, ItemActions.EDIT_IN_ALFRESCO);
    ...
    public void itemsAreDeletedRuleAppliesToSubfolders()
    {
        ...
        documentLibraryPage
            ...
            .clickOnFolderName(childFolder)
            .assertFileIsDisplayed(fileName)
            .selectItemAction(fileName, ItemActions.DELETE_DOCUMENT);
        deleteDialog
            .confirmDeletion();
