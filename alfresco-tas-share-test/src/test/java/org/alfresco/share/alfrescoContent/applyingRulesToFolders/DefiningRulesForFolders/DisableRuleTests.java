...
@Slf4j
public class DisableRuleTests extends AbstractFolderRuleTest
{
    ...
    public void disableRule()
    {
        ...
        log.info("Step 4: Veriy file should not be displayed in the document library");
        documentLibraryPage
