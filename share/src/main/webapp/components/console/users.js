   ...
   YAHOO.extend(Alfresco.ConsoleUsers, Alfresco.ConsoleTool,
   {
      ...
      onDeauthorizedButtonClick: function ConsoleUsers_onDeauthorizedButtonClick(e, cell)
      {
        var me = this;
         ...
         var body=this.msg("deauthorize.dialog.message", Alfresco.constants.DOCUMENTATION_URL) + "<br><br>&nbsp;&nbsp;<input type=\"checkbox\" name=\"isAgreed\" id=\"isAgreedID\" value=\"1\" />&nbsp;" + deauthCheckboxMessage;
