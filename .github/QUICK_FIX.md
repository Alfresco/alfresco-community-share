...
3. Paste contents from [BEDROCK_IAM_POLICY.json](BEDROCK_IAM_POLICY.json)
...
- Complete summary: [AI_HEALING_FIXES_SUMMARY.md](AI_HEALING_FIXES_SUMMARY.md)
- Original docs: [AI_SELF_HEALING.md](AI_SELF_HEALING.md)
