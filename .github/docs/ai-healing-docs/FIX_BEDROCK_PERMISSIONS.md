...
Apply the IAM policy from [BEDROCK_IAM_POLICY.json](../../../../.github/BEDROCK_IAM_POLICY.json) to the user.
...
4. Copy the contents of [.github/BEDROCK_IAM_POLICY.json](../../../../.github/BEDROCK_IAM_POLICY.json) and paste it
...
2. **Wrong IAM user:** Verify the workflow uses `AGS_AWS_ACCESS_KEY_ID` and `AGS_AWS_SECRET_ACCESS_KEY` secrets
