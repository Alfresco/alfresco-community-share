...
* [Community Documentation Link](https://docs.hyland.com/access?dita:id=sos1721648364102&vrm_version=26.1)
* [Enterprise Documentation Link](https://docs.hyland.com/access?dita:id=sos1721648364102&vrm_version=26.1)
* [Contribution Model](../../CONTRIBUTING.md)

***

### Prerequisite Knowledge
An understanding of Alfresco Content Services is assumed. The following pages from the [developer documentation](https://docs.hyland.com/access?dita:id=lsl1724405261585&vrm_version=26.1) give useful background information:
...
We use standard Alfresco [data modelling](https://docs.hyland.com/access?dita:id=bec1719554688839&vrm_version=26.1) to store RM metadata. We extend the [Alfresco patching mechanism](https://docs.hyland.com/access?dita:id=ekx1720080373621&vrm_version=26.1) to provide community and enterprise schema upgrades.
