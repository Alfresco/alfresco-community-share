...
* [Community Documentation Link](https://support.hyland.com/p/alfresco)
* [Enterprise Documentation Link](https://support.hyland.com/p/alfresco)
* [Contribution Model](../../CONTRIBUTING.md)

***

### Prerequisite Knowledge
An understanding of Alfresco Content Services is assumed. The following pages from the [developer documentation](https://support.hyland.com/p/alfresco) give useful background information:

* [ACS Architecture](https://support.hyland.com/p/alfresco)
* [Platform Extensions](https://support.hyland.com/p/alfresco)
* [Share Extensions](https://support.hyland.com/p/alfresco)
...
#### REST API
The REST API endpoints fall into two main types - v0 (Webscripts) and v1. The [v0 API](https://support.hyland.com/p/alfresco) is older and not recommended for integrations. The [v1 API](https://support.hyland.com/p/alfresco) is newer but isn't yet feature complete. If you are running RM locally then the GS API Explorer will be available at [this link](http://localhost:8080/gs-api-explorer/).
...
We use standard Alfresco [data modelling](https://support.hyland.com/p/alfresco) to store RM metadata. We extend the [Alfresco patching mechanism](https://support.hyland.com/p/alfresco) to provide community and enterprise schema upgrades.
