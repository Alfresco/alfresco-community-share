...
* [Community Documentation Link](https://docs.hyland.com/access?dita:id=sos1721648364102&vrm_version=25.3)
* [Enterprise Documentation Link](https://docs.hyland.com/access?dita:id=sos1721648364102&vrm_version=25.5)
* [Contribution Model](../../CONTRIBUTING.md)

***

### Prerequisite Knowledge
An understanding of Alfresco Content Services is assumed. The following pages from the [developer documentation](https://docs.hyland.com/access?dita:id=lsl1724405261585&vrm_version=25.5
) give useful background information:

* [ACS Architecture](https://docs.hyland.com/access?dita:id=lfo1719554691023&vrm_version=25.5)
* [Platform Extensions](https://docs.hyland.com/access?dita:id=ifr1720080387005&vrm_version=25.5)
* [Share Extensions](https://docs.hyland.com/access?dita:id=wqu1720687386891&vrm_version=25.5)
...
#### REST API
The REST API endpoints fall into two main types - v0 (Webscripts) and v1. The [v0 API](https://docs.hyland.com/access?dita:id=fga1720080409048&vrm_version=25.5) is older and not recommended for integrations. The [v1 API](https://docs.hyland.com/access?dita:id=cmm1721136574006&vrm_version=25.5) is newer but isn't yet feature complete. If you are running RM locally then the GS API Explorer will be available at [this link](http://localhost:8080/gs-api-explorer/).
...
We use standard Alfresco [data modelling](https://docs.hyland.com/access?dita:id=bec1719554688839&vrm_version=25.5) to store RM metadata. We extend the [Alfresco patching mechanism](https://docs.hyland.com/access?dita:id=ekx1720080373621&vrm_version=25.5) to provide community and enterprise schema upgrades.
