 ...
 * @class Alfresco.rm.component.RMListOfValues
 */
(function()
{
   /**
    ...
    * @return {Alfresco.rm.component.RMListOfValues} The new RecordsListOfValues instance
    * @constructor
    */
   Alfresco.rm.component.RMListOfValues = function(htmlId)
   {
      this.name = "Alfresco.rm.component.RMListOfValues";
      Alfresco.rm.component.RMListOfValues.superclass.constructor.call(this, htmlId);
      ...
      YAHOO.extend(ViewPanelHandler, Alfresco.ConsolePanelHandler,
      {
         ...
         onRenameListOfValueClick: function ViewPanelHandler_onRenameListOfValueClick(e, oRecord)
         {
            ...
            if (!this.modules.renameList)
            {
               ...
               {
                  width: "30em",
                  templateUrl: Alfresco.constants.URL_SERVICECONTEXT + "rm/modules/console/list-of-value-properties",
   ...
   YAHOO.extend(Alfresco.rm.component.RMListOfValues, Alfresco.ConsoleTool,
   {
      /**
      ...
      onReady: function RecordsListOfValues_onReady()
      {
         ...
         Alfresco.rm.component.RMListOfValues.superclass.onReady.call(this);
      },
