 ...
 * @class Alfresco.rm.component.RMEvents
 */
(function()
{
   /**
    ...
    * @return {Alfresco.rm.component.RMEvents} The new RecordsEvents instance
    * @constructor
    */
   Alfresco.rm.component.RMEvents = function(htmlId)
   {
      this.name = "Alfresco.rm.component.RMEvents";
      Alfresco.rm.component.RMEvents.superclass.constructor.call(this, htmlId);
   ...
   YAHOO.extend(Alfresco.rm.component.RMEvents, Alfresco.ConsoleTool,
   {
      /**
      ...
      onReady: function RecordsEvents_onReady()
      {
         ...
         Alfresco.rm.component.RMEvents.superclass.onReady.call(this);
      },
