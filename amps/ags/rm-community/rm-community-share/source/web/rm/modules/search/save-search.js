 ...
 * @class Alfresco.rm.module.SaveSearch
 */
(function()
{
    ...
    * @constructor
    */
   Alfresco.rm.module.SaveSearch = function(containerId)
   {
   ...
   YAHOO.extend(Alfresco.rm.module.SaveSearch, Alfresco.component.Base,
   {
      ...
      show: function SS_show()
      {
         ...
         else
         {
            ...
            {
               url: Alfresco.constants.URL_SERVICECONTEXT + "rm/modules/search/save-search",
               dataObj:
               {
                  htmlid: this.id
               },
...
Alfresco.module.getSaveSearchInstance = function()
{
   ...
   return Alfresco.util.ComponentManager.get(instanceId) || new Alfresco.rm.module.SaveSearch(instanceId);
};
