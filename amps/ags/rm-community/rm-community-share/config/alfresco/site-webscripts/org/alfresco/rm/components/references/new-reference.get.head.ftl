...
<@script type="text/javascript" src="${url.context}/res/rm/modules/document-picker/object-renderer.js"></@script>
<@script type="text/javascript" src="${url.context}/res/rm/components/references/new-reference.js"></@script>
